...
**Si question « certification / 6 blocs ».** Ce repo = **Bloc 6 Lean**. Les cas 1–5 sont dans `CDSD_Certification_Projets` (branche `cursor/cdsd-certification-portfolio`). Filet : [`FICHE_ORALE_PARCOURS.md`](FICHE_ORALE_PARCOURS.md) · [`ORAL_MINI_PROJETS.md`](ORAL_MINI_PROJETS.md). **Ne pas citer les 69 % / ~2 % de l’archive HPP.**
